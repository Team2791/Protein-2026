...
public class RobotContainer {
    ...
    final Climber climber = switch (RuntimeConstants.kCurrentMode) {
        case REAL -> {
            ...
            yield new Climber(
                    new AxleSpark(),
                    new CylinderPH(ph, IOConstants.Climber.kInnerFwd, IOConstants.Climber.kInnerRev),
                    new CylinderPH(ph, IOConstants.Climber.kOuterLeftFwd, IOConstants.Climber.kOuterLeftRev),
                    new CylinderPH(ph, IOConstants.Climber.kOuterRightFwd, IOConstants.Climber.kOuterRightRev));
        }
        default -> new Climber(
                new AxleReplay(),
                new CylinderReplay(),
